...
@CucumberOptions(features = {"src/test/resources/features/api/user_management/gym_postfeeback.feature"},
...
public class ApiPostFeedback extends AbstractTestNGCucumberTests {
}
