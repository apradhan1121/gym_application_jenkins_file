...
@CucumberOptions(features = {"src/test/resources/features/api/user_management/gym_cancelcoach.feature"},
...
public class ApiCancelCoach extends AbstractTestNGCucumberTests {
}
