...
@CucumberOptions(features = {"src/test/resources/features/api/user_management/gym_userworkouts.feature"},
...
public class ApiUserWorkouts extends AbstractTestNGCucumberTests {
}
