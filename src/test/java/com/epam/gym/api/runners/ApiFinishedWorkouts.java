...
@CucumberOptions(features = {"src/test/resources/features/api/role_management/gym_finishedworkouts.feature"},
...
public class ApiFinishedWorkouts extends AbstractTestNGCucumberTests {
}
